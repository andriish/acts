...
struct EffectiveMultiTrajectory {
 public:
  /// @brief Default constructor
  ///
  EffectiveMultiTrajectory() = default;
  ...
  /// index
  EffectiveMultiTrajectory(const Acts::MultiTrajectory<EffectiveSourceLink>& multiTraj,
  ...
  ///
  /// @param rhs The source EffectiveMultiTrajectory
  EffectiveMultiTrajectory(const EffectiveMultiTrajectory& rhs)
  ...
  ///
  /// @param rhs The source EffectiveMultiTrajectory
  EffectiveMultiTrajectory(EffectiveMultiTrajectory&& rhs)
  ...
  ///
  /// @param rhs The source EffectiveMultiTrajectory
  EffectiveMultiTrajectory& operator=(const EffectiveMultiTrajectory& rhs) {
    m_multiTrajectory = rhs.m_multiTrajectory;
    m_trackTips = rhs.m_trackTips;
    m_trackParameters = rhs.m_trackParameters;
    return *this;
  ...
  ///
  /// @param rhs The source EffectiveMultiTrajectory
  EffectiveMultiTrajectory& operator=(EffectiveMultiTrajectory&& rhs) {
    m_multiTrajectory = std::move(rhs.m_multiTrajectory);
    m_trackTips = std::move(rhs.m_trackTips);
    m_trackParameters = std::move(rhs.m_trackParameters);
    return *this;
  ...
  std::pair<std::vector<size_t>, Acts::MultiTrajectory<EffectiveSourceLink>>
  trajectory() const {
 ...
 private:
  // The multiTrajectory
  Acts::MultiTrajectory<EffectiveSourceLink> m_multiTrajectory;
