...
struct MaterialInteractionExtension {
  /// @brief Default constructor
  MaterialInteractionExtension() = default;
  ...
  int bid(const propagator_state_t& /*unused*/,
    ...
    return 9001; // TODO: test for surface material
  }
  ...
  template <typename propagator_state_t, typename stepper_t>
  bool k(const propagator_state_t& /*unused*/, const stepper_t& /*unused*/,
         Vector3D& /*unused*/, const Vector3D& /*unused*/, const int /*unused*/,
         const double /*unused*/, const Vector3D& /*unused*/) {
    return true;
  }
