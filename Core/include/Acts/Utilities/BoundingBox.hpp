...
class AxisAlignedBoundingBox {
 ...
 public:
  ...
  /// Equality operator
  bool operator==(
      const AxisAlignedBoundingBox<entity_t, value_t, DIM>& other) const {
    return (*m_entity == *other.m_entity) && (m_vmin == other.m_vmin) &&
           (m_vmax == other.m_vmax) && (m_center == other.m_center) &&
