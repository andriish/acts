...
void
ActsFatras::PDGtoG4Converter::fillPredefinedParticles()
{
...
void 
ActsFatras::PDGtoG4Converter::addParticle( G4ParticleDefinition* pDef) {
  if( pDef == nullptr)
      return;
  
  m_pdgG4ParticleMap[pDef->GetPDGEncoding()] = pDef;
}